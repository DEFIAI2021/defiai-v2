...
export interface IBiswapPairInterface extends utils.Interface {
  contractName: "IBiswapPair";
  functions: {
...
export interface IBiswapPair extends BaseContract {
  ...
  callStatic: {
    ...
    setDevFee(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;

    setSwapFee(arg0: BigNumberish, overrides?: CallOverrides): Promise<void>;
