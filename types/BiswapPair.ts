...
export interface BiswapPairInterface extends utils.Interface {
  contractName: "BiswapPair";
  functions: {
...
export interface BiswapPair extends BaseContract {
  contractName: "BiswapPair";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BiswapPairInterface;
